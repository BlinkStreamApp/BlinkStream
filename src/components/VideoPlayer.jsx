      ...
      {!error && !loading && (
        ...
        <div className="flex items-center gap-3 text-white/60">
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => openTwitchDropsWindow(false)} className="hover:text-purple-400 transition-colors cursor-pointer" title="Twitch Drops & Recompensas" aria-label="Abrir Twitch Drops">
